...
if 'OK' in response.text:
    ...
    save_path = r'C:\\Users\\PSzczubiala\\Desktop\\SK\\Sokker - wyciąganie informacji o zawodnikach\\MT'
...
df_players.to_excel(
    'C:\\Users\\PSzczubiala\\Desktop\\SK\\Sokker - wyciąganie informacji o zawodnikach\\MT\\players_MT.xlsx',
    index=False)

print("Pliki XML zostały pomyślnie przekonwertowane na tabelę Excel i zapisane jako 'players_MT'.")
