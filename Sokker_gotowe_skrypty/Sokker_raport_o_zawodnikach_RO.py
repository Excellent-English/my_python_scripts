...
if 'OK' in response.text:
    ...
    save_path = r'C:\\Users\\PSzczubiala\\Desktop\\SK\\Sokker - wyciąganie informacji o zawodnikach\\RO'
...
df_players.to_excel(
    'C:\\Users\\PSzczubiala\\Desktop\\SK\\Sokker - wyciąganie informacji o zawodnikach\\RO\\players_RO.xlsx',
    index=False)

print("Pliki XML zostały pomyślnie przekonwertowane na tabelę Excel i zapisane jako 'players_RO'.")
