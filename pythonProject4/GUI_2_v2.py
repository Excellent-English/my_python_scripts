...
def przegladaj(bg_color):
    ...
    back_button = ctk.CTkButton(new_window, text="Powrót do menu", font=("Helvetica", 12), text_color="white",
...
def dodaj(bg_color):
    ...
    save_button = ctk.CTkButton(master=new_window, text="Zapisz rekord", font=("Helvetica", 12), text_color="white", command=save_record)
...
button4 = ctk.CTkButton(frame, text="test", height=50, text_color="white", command=lambda: button_window4("white"))
