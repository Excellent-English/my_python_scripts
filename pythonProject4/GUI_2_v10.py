...
file_menu.add_command(label="Dodaj", command=lambda: dodaj())
...
button1 = ctk.CTkButton(frame, text="Przeglądaj", height=50, text_color="white", command=lambda: przegladaj())
button1.grid(row=1, column=0, padx=5, pady=10, sticky="nsew")

button2 = ctk.CTkButton(frame, text="Dodaj", height=50, text_color="white", command=lambda: dodaj())
