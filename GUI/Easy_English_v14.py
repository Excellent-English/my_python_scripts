...
def cwicz_wymowe():
    ...
    result_frame = ctk.CTkFrame(new_window, height=40, width=120)
    ...
    ctk.CTkLabel(result_frame,
                         ...
                         wraplength=250, font=("Helvetica", 16), anchor="center").grid(row=0, column=0, sticky="nsew", padx=10, pady=10)

    # Dodawanie przycisku "Play"
    new_button = ctk.CTkButton(new_window, text="⏵", font=("Helvetica", 16),text_color="white")
    ...
    new_button.grid(row=7, column=2, pady=10)
