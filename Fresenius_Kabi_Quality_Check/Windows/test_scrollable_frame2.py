...
# ============================================================
# FUNKCJA PO KLIKNIĘCIU WIERSZA
# ============================================================

def open_item(item):
    """
    Funkcja wykonywana po kliknięciu całego wiersza.
    Później można tutaj dodać przejście do strony szczegółów.
    """

    print(
        f"Wybrano item: {item['code']} | "
        f"{item['name']} | "
        f"{item['status']}"
    )
